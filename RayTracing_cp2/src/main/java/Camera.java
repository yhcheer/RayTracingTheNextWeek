public class Camera
{
    ...
    private float time0;    //开始时间
    private float time1;    //结束时间
     ...
     * @param aspect 宽高比
     */
    public Camera(Vec3 lookfrom, Vec3 lookat, Vec3 vup, float vfov, float aspect, float aperture, float focus_dist, float t0, float t1){
    ...
    public Ray GetRay(float u, float v)
    {
        ...
        float time = (float)( time0 + Math.random()*(time1 - time0) );
