...
public class Display {
    ...
    static String init(){
        ...
        String outputPath = "C:\\Users\\yh\\Documents\\CG\\result2\\";
        String pictureName = outputPath + "RayTracing01_" + df.format(new Date()) + ".ppm";
        return pictureName;
    }
...
//        List<Hitable> objList = random_scene();
    ...
    BvhNode random_scene() {
            ...
            for (int b = -11; b < 11; b++) {
                ...
                if ((center.Subtract(new Vec3(4,0.2f,0))).length() > 0.9) {
                    ...
                    if (choose_mat < 0.8) {     //diffuse
                        ...
                        objList.add(
                                new MovingSphere(center, center.Add(new Vec3(0, (float)( 0.5f*Math.random() ), 0)),0.0f, 1.0f, 0.2f,  new Lambertian(
        ...
        return new BvhNode(objList, objList.size(), 0, 1);
    }
